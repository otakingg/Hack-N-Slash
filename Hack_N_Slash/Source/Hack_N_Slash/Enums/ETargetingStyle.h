...
enum class ETargetingStyle : uint8
{
	...
	AlignCam UMETA(DisplayName = "Camera direction alignment"),
	AlignMove UMETA(DisplayName = "Move direction alignment"),
	AlignMoveOrCam UMETA(DisplayName = "NON-ZERO move direction alignment or camera direction alignment"),
	AlignMoveOrDist UMETA(DisplayName = "NON-ZERO move direction alignment or distance"),
	Dist UMETA(DisplayName = "Distance")
};